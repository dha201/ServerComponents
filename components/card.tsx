//To-Do: Date is a server component, but Card is a client component.
// However in this case, the date is being rendered as a client component.
// FIX: Move the date rendering to the server component.
...
type CardProps = {
  ...
  key: string;
  imgUrl?: string;
  // Method 1: formattedDate?: string; // UPDATED
  // Method 2 ///////////////
